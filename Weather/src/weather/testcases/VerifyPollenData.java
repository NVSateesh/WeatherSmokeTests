...
public class VerifyPollenData {
    public void plln() throws Exception {
	...
	while ((Content = BR.readLine()) != null) {
	    ...
	    // BR.close();
	    System.out.println("Index is :" + Content.indexOf("plln="));
		...
		if (FindText.contains("plln")) {
		    ...
		    if (ExactValue.contains(" ") || ExactValue.contains(data[2][7])) {
			System.out.println("NO Values found for plln");
			wResult.enterResult("TC", "Fail", ExactValue, 2, 7, 8);
		    } else

		    {
			System.out.println("plln vales is :" + FindText.contains(data[2][7]));
			System.out.println(FindText);
			wResult.enterResult("TC", "Pass", ExactValue, 2, 7, 8);
		    }
		    break;
		}
	    }
