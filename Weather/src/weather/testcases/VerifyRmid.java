...
public class VerifyRmid {

    public void verifyrmid() throws Exception {
	...
	while ((Content = BR.readLine()) != null) {
	    ...
	    // BR.close();
	    System.out.println("Index is :" + Content.indexOf("rmid="));
		...
		if (FindText.contains("rmid")) {
		    ...
		    if (ExactValue.contains(" ") || ExactValue.contains(data[5][7])) {
			System.out.println("NO Values found for rmid");
			wResult.enterResult("TC", "Fail", ExactValue, 5, 7, 8);
		    } else

		    {
			System.out.println("ord vales is :" + FindText.contains(data[5][7]));
			System.out.println(FindText);
			wResult.enterResult("TC", "Pass", ExactValue, 5, 7, 8);
		    }
		    break;
		}
	    }
